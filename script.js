/*
 TO DO:
  -- Add search functionaliity
  -- Add animations

*/

const trendingMovieBox = document.getElementById("trendingMovieBox");
const recommendedMovieBox = document.getElementById("recommendedMovieBox");
const movieBox = document.getElementById("movieBox");
const searchBox = document.getElementById("myInput");
let bookmarked = [];

// Add items from local storage to array
  ...
  try {
    ...
    for (movie of data) {
      ...
      if (movie.isTrending === true) {
        const movieDivTrending = document.createElement("div");
        movieDivTrending.classList.add("trending-movie");
        movieDivTrending.innerHTML = `
        <div class="trending-bookmark">
                <img
                  ...
                  alt="Bookmark"
                  class="trending-bookmark-img"
                />
              </div>
              <div class="trending-textbox">
                <h2 class="trending-movie-title">${movie.title}</h2>
                <ul class="trending-movie-list">
                  <li class="trending-movie-detail">${movie.year}</li>
                  <li class="trending-movie-detail">
                    <img
                  ...
                  <li class="trending-movie-detail">${movie.rating}</li>
                </ul>
              </div>`;

        movieDivTrending.style.backgroundImage = `url(${movie.thumbnail.trending.large})`;
        trendingMovieBox.appendChild(movieDivTrending);
      }

      //   Adding to recommended movie's homepage
      ...
      movieDiv.style.backgroundImage = `url(${movie.thumbnail.regular.medium})`;
      recommendedMovieBox.appendChild(movieDiv);
    }
    ...
    document.querySelectorAll(".recommended-bookmark").forEach((button) => {
      button.addEventListener("click", function () {
        ...
        // Write dataset attribute to be able to compare to data instance
